...
router.register(prefix="reactions", viewset=ReactionViewSet,
                basename="reactions")
router.register(prefix="tags", viewset=TagViewSet, basename="tags")
router.register(prefix="post-tags", viewset=PostTagViewSet,
                basename="post-tags")
router.register(prefix="hashtags", viewset=HashtagViewSet, basename="hashtags")
router.register(prefix="post-hashtags",
                viewset=PostHashtagViewSet, basename="post-hashtags")
